<template>
  <div class="bg-gray-50 border-b border-gray-200">
    <ProjectHeader />
    <div
      class="max-w-screen-sm mx-auto px-6 md:px-8 pt-20 pb-32 flex flex-col items-center"
    >
      <h1
        class="font-extrabold text-5xl leading-10 tracking-tight text-gray-900"
      >
        Recycle
      </h1>
      <h2
